...
function bossLoop() {
    ...
    if (isColliding(PLAYER.box, boss.element, -30)) {
        if (boss.attackCooldown <= 0) {
            ...
            // Kooperativ: Boss-Schaden an alle Spieler
            if (typeof sendCoopBossDamageToPlayers === 'function') {
                sendCoopBossDamageToPlayers(boss.damageToPlayer);
            }
        }
        ...
        if (boss.damageTakenCooldown <= 0) {
            ...
            // Kooperativ: Schaden an Boss senden
            if (typeof sendCoopBossDamage === 'function') {
                sendCoopBossDamage();
            }
