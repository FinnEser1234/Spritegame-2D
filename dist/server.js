...
io.on('connection', (socket) => {
    ...
    function startBossBattle() {
        ...
        const stats = diffStats[bossState.difficulty] || diffStats.normal;
    ...
    socket.on('damageToSharedBoss', (damage) => {
    ...
    socket.on('takeBossDamage', (damage) => {
        ...
        io.emit('playersHealthUpdate', Object.fromEntries(Object.entries(players).map(([id, p]) => [id, { health: p.health, maxHealth: p.maxHealth }])));
