...
function keyListenerDown(e) {
    if (e.key === "ArrowLeft" || e.key === "a" || e.key === "A") { // Left arrow
        KEY_EVENTS.leftArrow = true;
    }
    if (e.key === "ArrowUp" || e.key === "w" || e.key === "W") { // Up arrow
        KEY_EVENTS.upArrow = true;
    }
    if (e.key === "ArrowRight" || e.key === "d" || e.key === "D") { // Right arrow
        KEY_EVENTS.rightArrow = true;
    }
    if (e.key === "ArrowDown" || e.key === "s" || e.key === "S") { // Down arrow
